...
I think that a lot of my learning in the class came from the portfolio project.
It gave me freedom to design the component exactly how I wanted to, which not
only made the work more enjoyable, but it drove me to do my own research when I
got stuck. Overall the project reinforced my understanding of software developement.

> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?

It cleared a lot of information about the structure of these multi-leveled
components, as well as why interfaces are necessary. I also learned about enums
through this project when researching how I should store the cards information.

> Finally, as a part of completing the portfolio project, to what extent has
> your perspective of software development changed, if at all? In other words,
> is software development something you still enjoy? If not, why not?

The portfolio project was by far the most enjoyable task that I've done this year.
I don't think my perspectives changed much, but if anything, this definetly
helped me appreciate the effort put into software developement.
...
Research is important in software developement, in this component, I used some
methods that I've never used before, and I got better at finding how to use those
methods. Another skill that I developed would be planning. I drew out how
the component hiearchy would look, also before writing any code, I would put comments
on what I need to do in order to keep me on track and know exactly what I have to do.

> The follow-up question is: could you rephrase these skills you picked up
> as bullet points that you could put on a resume? Try it below.

- Software Developement Planning
- Efficient Research
...
I think it helped a lot, in the near future I want to be able to design apps or
programs by myself. In this project I did that in a language that I haven't used
before college, so I'm proud of myself even though this component is
small.
...
I think I should keep developing stuff like this, I think it would be beneficial
to use my component to make visual card games with buttons, images, online
multiplayer, etc.
...
- Designed two different use cases for CardDeck component
