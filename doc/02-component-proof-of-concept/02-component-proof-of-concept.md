...
I'm choosing to design the Card Deck component. I think it's more creative than the other designs and I like the idea of being able to use it to make card games in java. Out of the three concepts, Card Deck would probably be the most difficult, but I also think that it's more important to work on something interesting to me, even if it would take longer.
